...
var pathpoints = level.generate(scene);
...
visitor.startPos(pathpoints);
// gameloop
function render(){
	requestAnimationFrame(render);
	console.log(pathpoints + "Pathpoints in Script.")
	visitor.update(level,camera_FP,camera,pathpoints);
