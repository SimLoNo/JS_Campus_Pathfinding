export default class Visitor{
	...
	startPos(pathpoints){
		this.body.position.x = pathpoints[this.route[0]][1]+0.5;
		this.body.position.z = pathpoints[this.route[0]][2]+0.5;
	}	
	update(level, camera_FP,CamValue,pathpoints){
		...
		//if(this.body.position != new THREE.Vector3(pathpoints[this.route[this.walkPoint]][1],0,pathpoints[this.route[this.walkPoint]][2])){
			/*if(this.isRunning == false){
				if(this.isFacing == false){
					this.body.rotation.y += Math.floor(this.body.rotation.y + 1 * this.rotationSpeed);
				}
			}*/
			//this.body.lookAt(new THREE.Vector3(pathpoints[this.route[this.walkPoint]][1],0,pathpoints[this.route[this.walkPoint]][2]))
			
			if(this.body.position.x <= pathpoints[this.route[this.walkPoint]][1]+0.5 && this.body.position.x >= pathpoints[this.route[this.walkPoint]][1]-0.5){
				this.body.position.x = pathpoints[this.route[this.walkPoint]][1];

				if(this.body.position.z <= pathpoints[this.route[this.walkPoint]][2]+0.5 && this.body.position.z >= pathpoints[this.route[this.walkPoint]][2]-0.5){
					this.body.position.z = pathpoints[this.route[this.walkPoint]][2];
					this.walkPoint++;
				}
			...
			if (this.body.position.x < pathpoints[this.route[this.walkPoint]][1] || this.body.position.z < pathpoints[this.route[this.walkPoint]][2]){
			...
			//this.body.rotation.y += this.body.rotation.y + -1 * this.rotationSpeed;
		//}
		...
		camera_FP.lookAt(new THREE.Vector3(pathpoints[this.route[this.walkPoint]][1],0,pathpoints[this.route[this.walkPoint]][2]));
